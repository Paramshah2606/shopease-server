const forgotPasswordCodeTemplate = (userName, resetCode) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
        <style>
            ...
            .code-box { font-size: 22px; font-weight: bold; background: #ff6600; color: #ffffff; padding: 12px 25px; display: inline-block; border-radius: 6px; margin: 20px 0; letter-spacing: 3px; }
    ...
    <body>
        <div class="container">
            <div class="header">
                Cargo Password Reset Code 🔑  
            </div>
            <div class="content">
                <p>Hi <span class="highlight">${userName}</span>,</p>
                <p>We received a request to reset your Cargo account password.</p>
                <p>Use the following code to proceed with the password reset:</p>
...
module.exports = forgotPasswordCodeTemplate;
